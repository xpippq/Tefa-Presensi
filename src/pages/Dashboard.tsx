...
const Dashboard: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#4942E4] p-4">
      <div className="flex items-center justify-between p-4">
        <button className="text-white text-3xl bg-transparent">&#9776;</button>
      ...
      <div className="min-h-screen bg-white p-4">
        ...
        <div className="mt-8 bg-[#4942E4] p-6 rounded-lg shadow-md text-center">
        ...
        {/* Container untuk bagian History sampai Message */}
        <div className="mt-8 bg-white p-6 rounded-3xl shadow-md text-center">
